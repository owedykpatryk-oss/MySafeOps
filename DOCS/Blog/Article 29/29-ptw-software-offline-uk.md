...
UK construction sites are not offices. Tunnels, lift shafts, rural pipelines and pre-handover concrete cores kill 4G. A [permit to work system](https://mysafeops.com/blog/permit-to-work-app-uk) that needs constant connectivity pushes crews back to WhatsApp photos and clipboard permits.

This guide explains what offline should do, what vendors mean by the word, and how to test before you roll out across [hot work](https://mysafeops.com/blog/hot-work-permit-uk), [height](https://mysafeops.com/blog/height-work-permit-uk) and [electrical isolation](https://mysafeops.com/blog/electrical-isolation-permit-uk) permits.
...
If supervisors issue permits where work happens, offline is not a nice extra. It is core. Compare platforms in [best permit to work software UK 2026](https://mysafeops.com/blog/best-permit-to-work-software-uk-2026) with offline as a scored criterion.
...
> MySafeOps issues and closes [permits to work](https://mysafeops.com/blog/permit-to-work-app-uk) on site without relying on cabin Wi-Fi. Worker sign-off works on free operative accounts.
> [Start free →](/login)
...
2. Issue [hot work permit](https://mysafeops.com/blog/hot-work-permit-uk) with fire watch names
...
6. Repeat with [excavation permit](https://mysafeops.com/blog/excavation-permit-uk) if civils

Also ask about [construction safety app pricing](https://mysafeops.com/blog/construction-safety-app-pricing-uk-2026): offline is sometimes a higher tier add-on.

## How offline fits the wider PTW system

Offline permits should still link to RAMS and [CDM records](https://mysafeops.com/blog/cdm-2015-compliance-software-uk) when synced. A permit silo offline is better than paper, but integration wins audits.

For comparison with inspection-heavy tools see [SafetyCulture alternative UK](https://mysafeops.com/blog/safetyculture-alternative-uk). iAuditor offline is strong for checklists; confirm permit **lifecycle** depth for UK construction.

Principal contractors coordinating subbies need offline on **every** supervisor handset, not just the main contractor. See [subcontractor management software UK](https://mysafeops.com/blog/subcontractor-management-software-uk).
...
**See also:** [Permit to work app UK](https://mysafeops.com/blog/permit-to-work-app-uk) · [Best permit to work software UK 2026](https://mysafeops.com/blog/best-permit-to-work-software-uk-2026) · [Electrical isolation permit UK](https://mysafeops.com/blog/electrical-isolation-permit-uk)
