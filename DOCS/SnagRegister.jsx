...
function SnagCard({ snag, workers, onEdit, onDelete, onStatusChange }) {
...
export default function SnagRegister() {
  ...
  const deleteSnag = (id) => { if (confirm("Delete this snag item?")) { setSnags(prev=>prev.filter(s=>s.id!==id)); setModal(null); } };
