-- Allow Austrian country workspaces and de-AT document locale (extends DE pack).
...
alter table public.org_country_workspaces
  ...
  check (market_id in ('uk', 'pl', 'au', 'de', 'at'));
...
alter table public.org_country_workspaces
  ...
  check (default_document_locale in ('en-GB', 'pl-PL', 'en-AU', 'de-DE', 'de-AT'));
...
alter table public.org_document_language_preferences
  ...
  check (document_locale in ('en-GB', 'pl-PL', 'en-AU', 'de-DE', 'de-AT'));
...
alter table public.org_document_language_preferences
  ...
  check (bilingual_secondary_locale is null or bilingual_secondary_locale in ('en-GB', 'pl-PL', 'en-AU', 'de-DE', 'de-AT'));
