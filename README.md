...
1. **Products & prices:** either run `npm run stripe:seed-prices` (requires `STRIPE_SECRET_KEY` in `.env.local`; creates GBP monthly Solo £19 / Team £109 / Business £319 / Enterprise £649 and prints `STRIPE_PRICE_*` ids), or create four recurring prices manually in the [Stripe Dashboard](https://dashboard.stripe.com/).
