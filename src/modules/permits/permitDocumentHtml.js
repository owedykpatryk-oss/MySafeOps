...
export function renderPermitDocumentHtml(permit) {
  ...
  <style>
    ...
    *{box-sizing:border-box}
    body{font-family:Arial,sans-serif;font-size:12px;line-height:1.45;color:#000;margin:0;padding:16px 16px 32px;position:relative}
    ...
    .doc-top{display:flex;justify-content:space-between;align-items:center;gap:10px;margin-bottom:8px;flex-wrap:wrap}
    ...
    .header{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;border-bottom:3px solid ${themeTypeColor};padding-bottom:10px;margin-bottom:14px;flex-wrap:wrap}
    .ptw-type{background:${themeTypeBg};color:${themeTypeColor};padding:6px 14px;border-radius:6px;font-weight:bold;font-size:14px;max-width:min(42%,100%);text-align:right;overflow-wrap:anywhere;flex-shrink:0}
  ...
  <div class="header">
    <div style="display:flex;align-items:center;gap:14px">
      ${logoSrc ? `<img src="${escapeAttr(logoSrc)}" alt="" style="height:44px;max-width:120px;object-fit:contain"/>` : ""}
      <div>
