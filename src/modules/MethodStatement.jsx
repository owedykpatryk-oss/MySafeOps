  ...
  return (
    <div style={{ fontFamily:"DM Sans,system-ui,sans-serif", padding:"1.25rem 0", fontSize:14, color:"var(--color-text-primary)" }}>
      ...
      <div style={{ marginTop:20, padding:"12px 14px", background:"var(--color-background-secondary,#f7f7f5)", borderRadius:8, fontSize:12, color:"var(--color-text-secondary)", lineHeight:1.6 }}>
        Method statements include: document header, step-by-step work sequence with responsible persons, plant & equipment list, key materials, PPE requirements, emergency procedure, waste disposal and operative signatures. Print-ready A4 PDF.
      </div>
    </div>
  );
}
