...
import { escapeHtml, safeCssColor, safeImageSrc, openPrintWindow, escapeAttr } from "../utils/htmlEscape.js";
...
function printMonthlyReport(monthLabel) {
  ...
  win.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8"/><title>Monthly H&S summary — ${escapeHtml(monthLabel)}</title>
  <style>
