...
export function useBlogDocumentMeta(opts, enabled = true) {
  ...
  useEffect(() => {
    ...
    ensure("meta", { property: "og:site_name", content: siteName });
    ensure("meta", { property: "og:locale", content: locale });
    if (ogImageUrl) {
      ensure("meta", { property: "og:image", content: ogImageUrl });
    }
    if (ogType === "article" && articlePublishedTime) {
      ensure("meta", { property: "article:published_time", content: articlePublishedTime });
    }
    if (ogType === "article" && articleModifiedTime) {
      ensure("meta", { property: "article:modified_time", content: articleModifiedTime });
    }
