...
function boundsKey(lat, lng, boundaryRing, escapeRoutes) {
...
function ProjectSitePreviewMap({
  ...
  const geometryKey = useMemo(
    () => boundsKey(lat, lng, boundaryRing, escapeRoutes),
    [lat, lng, boundaryRing, escapeRoutes]
  );
  ...
  }, [geometryKey, boundaryRing, escapeRoutes, lat, lng]);
  ...
  if (!hasBoundary && !hasCoords && !(escapeRoutes || []).length) {
    return (
      <div
