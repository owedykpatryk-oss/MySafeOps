...
export const GEO_PHOTO_GROUP_PACKS = {
  ...
  "Rail & trackside": ["railInfrastructure"],
...
export const GEO_PHOTO_PRESETS = [
  ...
  { id: "possession_limit", label: "Possession / worksite limit", icon: "🛑", color: "#b91c1c", group: "Rail & trackside" },
  { id: "track_condition", label: "Track / ballast condition", icon: "🛤️", color: "#78350f", group: "Rail & trackside" },
  { id: "ole_equipment", label: "OLE / conductor rail", icon: "⚡", color: "#b45309", group: "Rail & trackside" },
  { id: "signalling_asset", label: "Signalling / lineside asset", icon: "🚦", color: "#1d4ed8", group: "Rail & trackside" },
  { id: "level_crossing", label: "Level crossing", icon: "🚸", color: "#ea580c", group: "Rail & trackside" },
  { id: "on_track_plant_setup", label: "On-track plant / access point", icon: "🚜", color: "#0f766e", group: "Rail & trackside" },
  { id: "rail_handback", label: "Handback / line clear check", icon: "✅", color: "#16a34a", group: "Rail & trackside" },
