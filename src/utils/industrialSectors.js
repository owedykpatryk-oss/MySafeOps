...
export const INDUSTRY_SECTOR_GROUPS = [
  {
    ...
    options: [
      ...
      { id: "rail", label: "Rail & trackside", hint: "Possessions, PTS/COSS competence, OLE and third rail", tags: ["PTS", "Possession"] },
...
const SECTOR_REGISTER_HINTS = {
  ...
  rail: ["Rail corridor access PTW", "OLE isolation permit", "PTS / COSS competence"],
