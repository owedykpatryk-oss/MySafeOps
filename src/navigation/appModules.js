...
export const MORE_TABS = [
  ...
  { id: "bhp-plan", label: "Plan BIOZ" },
  { id: "orz", label: "Ocena ryzyka zawodowego" },
  { id: "pl-druki", label: "Druki BHP" },
  { id: "pl-instrukcje", label: "Instrukcje stanowiskowe" },
  { id: "pl-czynniki", label: "Czynniki szkodliwe" },
  { id: "sige-plan", label: "SiGe-Plan" },
