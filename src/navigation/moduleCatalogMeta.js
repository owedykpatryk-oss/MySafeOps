...
export const MODULE_PDF_REGISTRY = {
  ...
  cdm: { key: "cdm_packs", columns: [{ k: "projectName", l: "Project" }, { k: "updatedAt", l: "Updated" }] },
  ...
  "toolbox-reg": { key: "toolbox_talks", columns: [{ k: "topic", l: "Topic" }, { k: "date", l: "Date" }, { k: "lead", l: "Lead" }] },
